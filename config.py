...
VOICE_SYSTEM_PROMPT = (
    ...
    "- start_time: \"H:MM AM/PM\" format if mentioned (optional)\n"
    "- end_time: \"H:MM AM/PM\" format if mentioned (optional)\n"
    "- date: \"YYYY-MM-DD\" format, default to today if not specified\n"
    "- emoji: Relevant emoji for the task (optional)\n\n"
    "TIME FORMAT RULES:\n"
    "- Always use 12-hour format with AM/PM (e.g., \"2:30 PM\", \"9:00 AM\")\n"
    "- Morning mentions = AM (e.g., \"morning meeting\" → \"9:00 AM\")\n"
    "- Afternoon/evening mentions = PM (e.g., \"afternoon call\" → \"2:00 PM\")\n"
